...
// forwardRef throughout, for the same reason as dialog.tsx: Radix's Presence
// attaches a ref for the mount/unmount animation, which a plain function
// component can't receive on React 18.
